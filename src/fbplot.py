...
def plot_new(
    ms, fcsts, colors, ax=None, uncertainty=True, plot_cap=True, xlabel='ds', ylabel='y',
    figsize=(10, 6), shadow=True
):
    ...
    for i in range(len(ms)):
        ...
        ax.plot(m.history['ds'].dt.to_pydatetime(), m.history['y'], color)
        if shadow:
